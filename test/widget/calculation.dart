...
void main() {
  ...
  testWidgets('History is shown correctly after single calculation', (WidgetTester tester) async {
    await _setSize(binding);
    ...
    expect(find.widgetWithText(CalculationHistoryContainer, '3 * 4 = 12'), findsOneWidget);
  });
}
